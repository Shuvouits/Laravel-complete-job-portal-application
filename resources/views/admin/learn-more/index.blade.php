            ...
            <div class="section-body">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.learn-more.update', 1) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <x-image-preview :height="200" :width="300" :source="getImagePath($learn?->image)" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control {{ hasError($errors, 'title') }}"
                                        name="title" value="{{ old('title', $learn?->title) }}">
