        ...
        <div class="row mt-50">
            <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                        <div class="image"
                            style="background-image: url({{ asset('frontend/assets/imgs/page/homepage1/location1.png') }});">
            ...
            <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                        <div class="image"
                            style="background-image: url({{ asset('frontend/assets/imgs/page/homepage1/location2.png') }}); ">
            ...
            <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                        <div class="image"
                            style="background-image: url({{ asset('frontend/assets/imgs/page/homepage1/location3.png') }});">
                            <span class="lbl-hot">Hot</span></div>
                    </a>
                    <div class="informations"><a href="jobs-grid.html">
                            <h5>New York, USA</h5>
            ...
            <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                        <div class="image"
                            style="background-image: url({{ asset('frontend/assets/imgs/page/homepage1/location4.png') }}); ">
                        </div>
                    </a>
                    <div class="informations"><a href="jobs-grid.html">
            ...
            <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                        <div class="image"
                            style="background-image: url({{ asset('frontend/assets/imgs/page/homepage1/location5.png') }}); ">
                        </div>
                    </a>
                    <div class="informations"><a href="jobs-grid.html">
            ...
            <div class="col-xl-3 col-lg-3 col-md-5 col-sm-12 col-12">
                <div class="card-image-top hover-up"><a href="jobs-grid.html">
                        <div class="image"
                            style="background-image: url({{ asset('frontend/assets/imgs/page/homepage1/location6.png') }}); ">
                        </div>
                    </a>
                    <div class="informations"><a href="jobs-grid.html">
