                                        ...
                                        <div class="form-group">
                                            <ul class="list-checkbox">
                                                ...
                                                <li>
                                                    <label class="cb-container">
                                                        <input type="checkbox"><span
                                                            class="text-small">Director</span><span
                                                            class="checkmark"></span>
                                                    </label><span class="number-item">76</span>
                                                </li>
                                                <li>
                                        ...
                                        <div class="form-group">
                                            <ul class="list-checkbox">
                                                <li>
                                                    <label class="cb-container">
                                                        <input type="checkbox"><span
                                                            class="text-small">On-site</span><span
                                                            class="checkmark"></span>
                                                    </label><span class="number-item">12</span>
                                                </li>
                                                <li>
                                                    <label class="cb-container">
                                                        <input type="checkbox" checked="checked"><span
                                                            class="text-small">Remote</span><span
                                                            class="checkmark"></span>
                                                    </label><span class="number-item">65</span>
                                                </li>
                                                <li>
                                    ...
                                    <div class="filter-block mb-30">
                                        ...
                                        <div class="form-group">
                                            <ul class="list-checkbox">
                                                ...
                                                <li>
                                                    <label class="cb-container">
                                                        <input type="checkbox"><span class="text-small">30
                                        ...
                                        <div class="card-grid-2 hover-up">
                                            <div class="card-grid-2-image-left">
                                                ...
                                                <div class="card-profile pt-10">
                                                    <a href="candidate-details.html" style="display: flex; align-items: center; justify-content: space-between">
                                                        <h5>{{ $item->user->name }}</h5>
                                                        <span>{{$item->status=='available' ? 'Available' : 'Unavailable'}}</span>
                                                    </a>
                                                    <span class="font-xs color-text-mutted">{{ $item->title }}</span>
                                                    <div class="rate-reviews-small pt-5 d-flex mt-2">
                                                        <span>
                                            ...
                                            <div class="card-block-info">
                                                <p class="font-xs color-text-paragraph-2">{!! $item->bio !!}</p>
                                                <div class="card-2-bottom card-2-bottom-candidate mt-30">
                                                    <div class="text-start">

                                                        @foreach($item->skills as $data)
                                                ...
                                                <div
                                                    ...
                                                    <div class="row align-items-center">
                                                        <div class="col-9"><span class="d-flex align-items-center"><i
                                                                    ...
                                                                    class="font-sm color-text-mutted">{{$item->states->name}},
                                                                    {{$item->countries->name}}</span></span></div>
                                                        <div class="col-3">
                                                            <a href="/candidate/details/{{$item->slug}}" style="font-weight: bold; color: #1ca774">Details</a>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
