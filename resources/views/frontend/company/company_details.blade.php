        ...
        <section class="section-box-2">
            <div class="container">
                <div class="banner-hero banner-image-single"><img style="height: 374px; object-fit: cover;"
                        src="{{ getImagePath($company->banner) }}" alt="joblist"></div>
                <div class="box-company-profile">
                    <div class="row mt-10">
                        <div class="col-lg-8 col-md-12">
                            <div>
                                <img style="width: 100px;height: 100px;object-fit: cover;" src="{{ getImagePath($company->logo) }}"
                                    alt="">
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 text-lg-end"><a class="btn btn-apply btn-apply-big"
                                href="javascript:;"
                                onclick="document.getElementById('open-positions').scrollIntoView()">Open Positions</a>
                        </div>
                    </div>
                </div>
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <div class="sidebar-text-info"><span class="text-description">Organization Type
                                                ...
                                                class="small-heading">{{ $company->organizationType->name }}</strong>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="sidebar-icon-item"><i class="fi fi-rr-user"></i></div>
                                        <div class="sidebar-text-info"><span class="text-description">Team
                                                Size</span><strong
